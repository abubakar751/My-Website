...
const Footer = () => {
  ...
  return (
    <>
      {/* ================= SEO START ================= */}
      <Helmet>
        <title>Abu Bakar | Java Developer | Software Developer</title>
      ...
      <footer className="bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-primary-foreground/80 max-w-md mb-6 leading-relaxed">
                Passionate Java developer specializing in building robust,
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a
                    ...
                    className="flex items-center gap-3 text-primary-foreground/70 hover:text-secondary"
                  >
          ...
          {/* Bottom Bar */}
          <div className="py-6 border-t border-primary-foreground/10 text-sm text-primary-foreground/60">
